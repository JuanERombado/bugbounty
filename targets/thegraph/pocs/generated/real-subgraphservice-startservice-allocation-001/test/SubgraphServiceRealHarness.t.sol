...
contract SubgraphServiceRealHarnessTest is Test {
    ...
    // Hypothesis: STARTSERVICE-ALLOCATION-001
    // Local-only invariant: startService should create exactly one allocation and update subgraph accounting.
    function test_STARTSERVICE_ALLOCATION_001_startServiceCreatesAllocationAndTracksSubgraphTokens() public {
    ...
    function test_STARTSERVICE_ALLOCATION_001_cannotReuseAllocationId() public {
        uint256 tokens = 2 ether;
    ...
    function test_STARTSERVICE_ALLOCATION_001_invalidAllocationProofCannotStartService() public {
